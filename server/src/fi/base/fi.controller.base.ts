...
export class FiControllerBase {
  ...
  async create(@common.Body() data: FiCreateInput): Promise<Fi> {
  ...
  @ApiNestedQuery(FiFindManyArgs)
  async findMany(@common.Req() request: Request): Promise<Fi[]> {
  ...
  async update(
    @common.Param() params: FiWhereUniqueInput,
    @common.Body() data: FiUpdateInput
  ): Promise<Fi | null> {
    try {
